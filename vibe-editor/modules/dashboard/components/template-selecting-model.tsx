                        ...
                        className={`relative flex p-6 border rounded-lg cursor-pointer transition-all duration-300 hover:scale-[1.02]
                            ${
                              selectedTemplate === template.id
                                ? "border-[#f2690d] shadow-[0_0_0_1px_##9b63ff,0_8px_20px_rgba(233,63,63,0.15)]"
                                : "hover:border-[#f74104] shadow-[0_2px_8px_rgba(0,0,0,0.05)] hover:shadow-[0_2px_8px_rgba(0,0,0,0.1)]"
                            }
